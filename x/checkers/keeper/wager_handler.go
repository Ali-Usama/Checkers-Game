...
// CollectWager happens on a player's first move
...
// MustPayWinnings takes place when the game has a declared winner
...
// MustRefundWager takes place when the game has partially started, i.e. only one party has paid, or when the game ends in a draw
